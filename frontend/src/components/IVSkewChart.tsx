...
export default function IVSkewChart({ data, spot, futures }: Props) {
  ...
  if (filtered.length === 0) return <ChartEmptyState>No IV skew points are available within the current spot range.</ChartEmptyState>
  ...
  const option: EChartsOption = {
    ...
    grid: chartGrid({ left: 62, right: 18, top: 50, bottom: 48 }),
